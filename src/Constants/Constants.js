export default {
  ...
  vendorList: [
    { value: 'AQM', label: 'AQM' },
    { value: 'Clover Infotech', label: 'Clover Infotech' },
    { value: 'F A Software', label: 'F A Software' },
    // { value: 'Hitachi Systems', label: 'Hitachi Systems' },
    // { value: 'IBM', label: 'IBM' },
    // { value: 'Jayaa IT Solutions', label: 'Jayaa IT Solutions' },
    ...
    // { value: 'Kyndryl', label: 'Kyndryl' },
    // { value: 'LTI', label: 'LTI' },
    // { value: 'Sunfire Technology', label: 'Sunfire Technology' },
    // { value: 'Fludonomics', label: 'Fludonomics' },
    { value: 'Harjai', label: 'Harjai' },
    { value: 'Techniscion', label: 'Techniscion' },
    { value: 'Apmosys', label: 'Apmosys' },
