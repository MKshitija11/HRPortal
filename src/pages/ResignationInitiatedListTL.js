...
export default function ResignationInitiatedListTL() {
      ...
      Configuration.getEmpListTeamLead(getEmpListTLReq)
        .then((empListTLRes) => {
          ...
          if (empListTLRes.data.error) {
            ...
            console.log('emplist TL>>>>>>>', empListTLRes);
            setPendingEmployees(
              filteredUsers.filter((employees) => employees.employeeStatus === 'Resignation Initiated')
            );
      ...
      Configuration.getEmpListManager(empListManagerReq)
        .then((empListManagerRes) => {
          if (empListManagerRes.data.error) {
            ...
            console.log("resigned I>>>>", filteredUsers.filter((employees) => employees.employeeStatus === 'Resignation Initiated'))
